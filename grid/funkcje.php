...
function niefajne($name1, $name2, $name3, $kolumna1, $kolumna2, $kolumna3, $kolumna4, $kolumna5){
    require("../connect.php");
    $sql = "Select ".$name1.".".$kolumna1.", ".$kolumna4.", ".$kolumna5." from `jkako2307_1`.".$name1.", `jablonski-filip_pbd`.".$name2.", `kako2307_1`.".$name3." where ".$name2.".".$kolumna1."=".$kolumna2." and ".$name3.".".$kolumna1."=".$kolumna3." order by id asc";
    $result = mysqli_query($conn, $sql);
